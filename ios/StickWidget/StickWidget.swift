...
struct StickWidgetView: View {
    ...
    private var accentColor: Color {
        switch stateRaw {
        case "sit":   return Color(red: 0.92, green: 0.34, blue: 0.05)  // 橙
        case "sleep": return Color(red: 0.39, green: 0.40, blue: 0.95)  // 靛
        default:      return Color(red: 0.02, green: 0.59, blue: 0.41)  // 绿
        }
    }
}

// MARK: - 迷你火柴人（极简版，2x2 适配）
