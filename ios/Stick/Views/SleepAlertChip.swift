...
struct SleepAnomalyReportView: View {
    ...
    private var riskColor: Color {
        ...
        case .low:     return Theme.moveGreen      // 绿
        case .moderate: return Theme.riskWarn     // 琥珀
        case .high:   return Theme.riskHigh        // 红
        }
    }
...
struct SleepIssueRow: View {
    ...
    private var severityColor: Color {
        ...
        case .mild:     return Theme.riskWarn        // 琥珀
        case .moderate: return Theme.riskHigh        // 警示红
        }
    }
...
private struct SleepAlertAICard: View {
    ...
    private var riskColor: Color {
        switch aiAnalysis.riskLevel {
        case .low:     return Theme.moveGreen
